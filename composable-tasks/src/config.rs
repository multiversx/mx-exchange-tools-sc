    ...
    + external_sc_interactions::wegld_swap::WegldWrapModule
{
    ...
    fn set_pair_address_for_tokens(&self, first_token_id: &TokenIdentifier, second_token_id: &TokenIdentifier, new_addr: ManagedAddress) {
        self.pair_address_for_tokens(first_token_id, second_token_id).set(new_addr);
    }
}