// use composable_tasks::{composable_tasks_proxy, ProxyTrait};
// use multiversx_sc::types::{Address, MultiValueEncoded, TestAddress, TestSCAddress};
...
// const COMPOSABLE_TASKS_ADDRESS: TestSCAddress = TestSCAddress::new("composable_tasks");
// const WEGLD_ADDRESS: TestSCAddress = TestSCAddress::new("wegld_contract");
